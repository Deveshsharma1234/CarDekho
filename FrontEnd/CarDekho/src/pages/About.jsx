...
import { getGradianShiftClass } from '../utils/css/getBackground';

const About = () => {

  return (
    <div className="bg-gradient-to-br from-black to-pink-950 text-white min-h-screen flex flex-col items-center justify-center">
    
      <div className="max-w-4xl mx-auto">
        <h1 className={`text-4xl sm:text-5xl font-extrabold text-center mb-8 ${getGradianShiftClass()}`}>
          About Car Dekho Website
        </h1>
