...
const location = useLocation();
  ...
  className={`bg-base-200    transition-all  ${getBgClass(location.pathname)}  backdrop-blur-2xl duration-300 ${
    isOpen ? 'w-70' : 'w-7'
  }`}
>
  ...
  {!isOpen && (
    <div
      className={`h-full flex items-center justify-center cursor-pointer  ${getBgClass(location.pathname)}  text-white`}
